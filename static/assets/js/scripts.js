            ...
            $('#style-switcher').each(function() {
                ...
                skins.click(function() {
                    ...
                    if ($('head #skin-temp').length < 1) {
                        $('head').append('<link id="skin-temp" rel="stylesheet" type="text/css" href="/static/assets/css/skin/' + $(this).data('skin') + '.css">');
                    } else {
                        $('#skin-temp').attr('href', '/static/assets/css/skin/' + $(this).data('skin') + '.css');
                    }
                });
